# Payment Recovery Judge Pitch Script (5 Minutes)
...
1:00–2:00 │ The Solution: Constrained Economic Decision Agent
...
> *"We evaluated Payment Recovery using Self-Normalized Importance Sampling (SNIPS) counterfactual evaluation on 15,000 test episodes:
> - **Deterministic Baseline EV**: ₹1,671.74 / event
> - **Payment Recovery Policy EV**: **₹2,353.54 / event**
> - **Net Uplift**: **+40.78% (+₹681.80 / event)** measured directly against the simulator on all 15,000 episodes
> - **Oracle Regret**: **₹3.12 / event** (99.87% of the oracle ceiling; the policy never beats the oracle on any individual episode)
